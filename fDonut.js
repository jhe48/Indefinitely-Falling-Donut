...
Array(200).fill().forEach(addYellow_Sprinkles);
...
Array(200).fill().forEach(addPurple_Sprinkles);
...
Array(200).fill().forEach(addRed_Sprinkles);
...
// Combine elements to make scene.
scene1.add(
  donut,
  flashlight,
  spotlight
